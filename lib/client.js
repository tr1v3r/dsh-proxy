...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CSS = `
			...
			.dshProxyQuick{box-sizing:border-box;flex:none;width:36px;height:36px;margin:8px 0 0}.dshProxyQuick.rail{margin:0}
		...
		function ProxyQuick({ scope, t, wide }) {
			...
			const anchor = React.createElement(Tooltip, { label, delayMs: 500, disabled: open },
				React.createElement('button', {
					...
					React.createElement(IconGlobeOutline14, { size: 18 }),
