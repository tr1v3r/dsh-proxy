...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const COPY = {
			zh: {
				title: '网络代理', description: '控制 DSH 进程内请求的出口；也可直接编辑 profile 的 cordis.patch.yml',
			...
			en: {
				title: 'Network proxy', description: 'Route DSH requests; the profile cordis.patch.yml remains editable',
