...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CSS = `
			...
			.dshProxyQuickState{min-width:0;overflow:hidden;text-overflow:ellipsis}.dshProxyQuickError{padding:0 8px;color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}
		`;
